...
public class Gbdbs4bfs {
    ...
    private void convertGbdbsEle(JAXBElement ele) throws JAXBException {
    ...
    private void convertRecht(JAXBElement<? extends RechtType> value) throws JAXBException {
        if(value.getValue() instanceof EigentumAnteilType) {
            ms.marshal(value, out);
        }
    }
    private void convertGrundstueck(JAXBElement<? extends GrundstueckType> ele) throws JAXBException {
